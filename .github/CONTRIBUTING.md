...
--------------
 ...
 1. Go [to the list of YEntityGeneratorBundle issues][issues] and look for any
...
create the [Symfony Standard Edition][symfony-standard] reproducing the bug.
...
`symfony/symfony-docs` by `uay/YEntityGeneratorBundle` in every example.
...
[issues]: https://github.com/uay/YEntityGeneratorBundle/issues
[create-issue]: https://github.com/uay/YEntityGeneratorBundle/issues/new
